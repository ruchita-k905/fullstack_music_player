...
const EditProfile = ({ onClose }) => {
  ...
  //   for imagekit=> raw img to base64Image
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      dispatch(
        setError(serverMessage || 'Profile update failed! please try agian'),
      );
    } finally {
  ...
  return (
    <div className="editprofile-wrapper">
      ...
      <form className="edditprofile-form" onSubmit={handleSubmit}>
        {!showPasswordFields && (
          <>
